...
**リリース**: https://github.com/STsuruga/Graphica/releases/tag/v1.3.0
(`core/version.py`は`1.3.0`)。Windows exe・macOS `.app`(未署名、Apple
...
`master`(クリーン、push済み、`v1.3.0`タグ付き)。トラック1(PR #1)・
